...
public class ReporteService {
    ...
    // Conteo de reportes agrupados por estado
    @Transactional(readOnly = true)
    public List<EstadoReporteCountDTO> conteoPorEstado() {
        List<EstadoReporteCountDTO> resultado = reporteRepository.countReportesPorEstado();
